...
- Support for the open-vocabulary semantic segmentation algorithm [SAN](../mmmlab/configs/san/README.md)

- Support monocular depth estimation task, please refer to [VPD](../mmmlab/configs/vpd/README.md) and [Adabins](projects/Adabins/README.md) for more details.
...
- [x] ResNet (CVPR'2016)
- [x] ResNeXt (CVPR'2017)
- [x] [HRNet (CVPR'2019)](../mmmlab/configs/hrnet)
- [x] [ResNeSt (ArXiv'2020)](../mmmlab/configs/resnest)
- [x] [MobileNetV2 (CVPR'2018)](../mmmlab/configs/mobilenet_v2)
- [x] [MobileNetV3 (ICCV'2019)](../mmmlab/configs/mobilenet_v3)
- [x] [Vision Transformer (ICLR'2021)](../mmmlab/configs/vit)
- [x] [Swin Transformer (ICCV'2021)](../mmmlab/configs/swin)
- [x] [Twins (NeurIPS'2021)](../mmmlab/configs/twins)
- [x] [BEiT (ICLR'2022)](../mmmlab/configs/beit)
- [x] [ConvNeXt (CVPR'2022)](../mmmlab/configs/convnext)
- [x] [MAE (CVPR'2022)](../mmmlab/configs/mae)
- [x] [PoolFormer (CVPR'2022)](../mmmlab/configs/poolformer)
- [x] [SegNeXt (NeurIPS'2022)](../mmmlab/configs/segnext)
...
- [x] [SAN (CVPR'2023)](../mmmlab/configs/san/)
- [x] [VPD (ICCV'2023)](../mmmlab/configs/vpd)
- [x] [DDRNet (T-ITS'2022)](../mmmlab/configs/ddrnet)
- [x] [PIDNet (ArXiv'2022)](../mmmlab/configs/pidnet)
- [x] [Mask2Former (CVPR'2022)](../mmmlab/configs/mask2former)
- [x] [MaskFormer (NeurIPS'2021)](../mmmlab/configs/maskformer)
- [x] [K-Net (NeurIPS'2021)](../mmmlab/configs/knet)
- [x] [SegFormer (NeurIPS'2021)](../mmmlab/configs/segformer)
- [x] [Segmenter (ICCV'2021)](../mmmlab/configs/segmenter)
- [x] [DPT (ArXiv'2021)](../mmmlab/configs/dpt)
- [x] [SETR (CVPR'2021)](../mmmlab/configs/setr)
- [x] [STDC (CVPR'2021)](../mmmlab/configs/stdc)
- [x] [BiSeNetV2 (IJCV'2021)](../mmmlab/configs/bisenetv2)
- [x] [CGNet (TIP'2020)](../mmmlab/configs/cgnet)
- [x] [PointRend (CVPR'2020)](../mmmlab/configs/point_rend)
- [x] [DNLNet (ECCV'2020)](../mmmlab/configs/dnlnet)
- [x] [OCRNet (ECCV'2020)](../mmmlab/configs/ocrnet)
- [x] [ISANet (ArXiv'2019/IJCV'2021)](../mmmlab/configs/isanet)
- [x] [Fast-SCNN (ArXiv'2019)](../mmmlab/configs/fastscnn)
- [x] [FastFCN (ArXiv'2019)](../mmmlab/configs/fastfcn)
- [x] [GCNet (ICCVW'2019/TPAMI'2020)](../mmmlab/configs/gcnet)
- [x] [ANN (ICCV'2019)](../mmmlab/configs/ann)
- [x] [EMANet (ICCV'2019)](../mmmlab/configs/emanet)
- [x] [CCNet (ICCV'2019)](../mmmlab/configs/ccnet)
- [x] [DMNet (ICCV'2019)](../mmmlab/configs/dmnet)
- [x] [Semantic FPN (CVPR'2019)](../mmmlab/configs/sem_fpn)
- [x] [DANet (CVPR'2019)](../mmmlab/configs/danet)
- [x] [APCNet (CVPR'2019)](../mmmlab/configs/apcnet)
- [x] [NonLocal Net (CVPR'2018)](../mmmlab/configs/nonlocal_net)
- [x] [EncNet (CVPR'2018)](../mmmlab/configs/encnet)
- [x] [DeepLabV3+ (CVPR'2018)](../mmmlab/configs/deeplabv3plus)
- [x] [UPerNet (ECCV'2018)](../mmmlab/configs/upernet)
- [x] [ICNet (ECCV'2018)](../mmmlab/configs/icnet)
- [x] [PSANet (ECCV'2018)](../mmmlab/configs/psanet)
- [x] [BiSeNetV1 (ECCV'2018)](../mmmlab/configs/bisenetv1)
- [x] [DeepLabV3 (ArXiv'2017)](../mmmlab/configs/deeplabv3)
- [x] [PSPNet (CVPR'2017)](../mmmlab/configs/pspnet)
- [x] [ERFNet (T-ITS'2017)](../mmmlab/configs/erfnet)
- [x] [UNet (MICCAI'2016/Nat. Methods'2019)](../mmmlab/configs/unet)
- [x] [FCN (CVPR'2015/TPAMI'2017)](../mmmlab/configs/fcn)
