    ...
    def total_area_to_metrics(total_area_intersect: np.ndarray,
        ...
        for metric in metrics:
            ...
            if metric == 'mIoU':
                ...
                # 添加SEN、SPC、HD和MAE
                SEN = total_area_intersect / total_area_label
                #SPC = total_area_non_intersect / total_area_non_pred_label
                # 计算Hausdorff距离（HD）
                HD = hausdorff_distance(total_area_label, total_area_pred_label)
                # 计算平均绝对误差（MAE）
                MAE = torch.mean(torch.abs(total_area_pred_label - total_area_label))
                ret_metrics['IoU'] = iou
                # ret_metrics['Dice'] = dice
                # ret_metrics['Recall'] = acc
                # ret_metrics['precision'] = precision
