...
class SeaFormer(nn.Module):
    ...
    def init_weights(self):
        ...
        if isinstance(self.pretrained, str):
            ...
            #     self.pretrained,filename=self.init_cfg['checkpoint'], logger=logger, map_location='cpu')
    ...
    def forward(self, x):
        ...
        print('num_smb_stage',num_smb_stage)
        print('num_trans_stage', num_trans_stage)
