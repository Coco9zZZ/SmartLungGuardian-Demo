...
class SwinTransformer(BaseModule):
    ...
    def __init__(self,
        ...
        self.conv2 = torch.nn.Conv2d(in_channels=384*4, out_channels=768, kernel_size=1, stride=1).to('cuda')
    ...
    def forward(self, x):
        ...
        downlist.append(f)#96 192 384 768
