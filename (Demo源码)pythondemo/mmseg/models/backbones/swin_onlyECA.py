...
class SwinTransformer(BaseModule):
    ...
    def __init__(self,
        ...
        inlist_2 = [256, 512, 1024,2048]
        self.downconvs = nn.ModuleList([
            nn.Conv2d(in_channels, int(in_channels/2), kernel_size=1, stride=1).to('cuda')
    ...
    def forward(self, x):
        ...
        downlist=[]
        for k in range(4):
            z =self.downconvs[k](RxECAList[k])
            downlist.append(z)
        return downlist
