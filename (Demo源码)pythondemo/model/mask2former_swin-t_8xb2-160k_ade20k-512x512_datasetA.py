...
data_root = 'D:\\test\\mmlab\\mmseg\\data\\Covid_class'
...
test_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            img_path=
            'D:\\test\\mmlab\\mmseg\\data\\Covid\\Covid_MedSeg_1\\val\\images',
            seg_map_path=
            'D:\\test\\mmlab\\mmseg\\data\\Covid\\Covid_MedSeg_1\\val\\masks_ade'
        ),
        data_root='D:\\test\\mmlab\\mmseg\\data\\Covid_class',
        pipeline=[
...
train_cfg = dict(max_iters=50000, type='IterBasedTrainLoop', val_interval=1000)
train_dataloader = dict(
    batch_size=2,
    dataset=dict(
        data_prefix=dict(
            img_path=
            'D:\\test\\mmlab\\mmseg\\data\\Covid\\Covid_MedSeg_1\\train\\images',
            seg_map_path=
            'D:\\test\\mmlab\\mmseg\\data\\Covid\\Covid_MedSeg_1\\train\\masks_ade'
        ),
        data_root='D:\\test\\mmlab\\mmseg\\data\\Covid_class',
        pipeline=[
            dict(type='LoadImageFromFile'),
...
work_dir = 'D:\\test\\mmlab\\mmseg\\wook_dirs_covid_ana\\analoss_mask2former_swin-t_8xb2-160k_ade20k-512x512_datasetA.py'
